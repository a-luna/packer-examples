...
#
# This script installs NGINX using the .deb package produced from 
# bash script 01a-build_nginx_from_source.sh. The .deb file and source
# code are uploaded to the host machine and not downloaded as in
# 01a-build_nginx_from_source.sh. So, for example, this script would 
# be useful for a scenario where internet access is not available on
# the host machine, or you must install NGINX on several different 
# OS variants for compatibility testing.
##########################################################################
